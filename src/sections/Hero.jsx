...
const Hero = () => {
  ...
  return (
    <section className="max-container w-full min-h-screen flex flex-col lg:flex-row gap-10 justify-center">
      <section className="relative  w-full xl:w-2/5 flex flex-col items-start justify-center pt-28  ">
        ...
        <h1 className=' mt-10 font-palanquin text-8xl font-bold max-sm:text-[72px] max-sm:leading-[82px]'>
          <span className='xl:bg-white xl:whitespace-nowrap relative z-10 pr-10 '>The New Arrival</span> <span className="text-coral-red inline-block mt-3">Nike</span> Shoes</h1>
      ...
      <section className="relative flex-1 flex items-center justify-center max-sm:py-40  bg-hero bg-center bg-cover">
        <img src={imageState} alt="nike" className="relative z-10" />
